...
static gboolean cb_tsin_cursor_color( GtkWidget *widget,
                                   gpointer   data )
{
   GtkColorSelectionDialog *color_selector = (GtkColorSelectionDialog *)gtk_color_selection_dialog_new (_(_L("詞音游標的顏色")));
...
static gboolean cb_tsin_phrase_line_color( GtkWidget *widget,
                                   gpointer   data )
{
   GtkColorSelectionDialog *color_selector = (GtkColorSelectionDialog *)gtk_color_selection_dialog_new (_(_L("詞音標示詞的底線顏色")));
...
static struct {
 ...
 {N_(_L("標準 standard 使用 asdf 選擇")), "zo-asdf"},
 {N_(_L("倚天 Eten")), "et"},
 {N_(_L("倚天 Eten 使用 asdf 選擇")), "et-asdf"},
 {N_(_L("倚天 26 鍵")), "et26"},
 {N_(_L("倚天 26 鍵,使用 asdf 選擇")), "et26-asdf"},
 {N_(_L("許氏(國音,自然)")), "hsu"},
 {N_(_L("聲調拼音")), "pinyin"},
 {N_(_L("聲調拼音, 使用 asdf 選擇")), "pinyin-asdf"},
 {N_(_L("Dvorak")), "dvorak"},
 {N_(_L("IBM")), "ibm"},
 {N_(_L("神通")), "mitac"},
 {NULL, NULL}
...
#else
  char fname[512];
  get_gcin_user_fname("phrase-ctrl.table", fname);
  win32exec_script("utf8-edit.bat", fname);
#endif
}
                                   ...
                                   gpointer   data )
{
  ...
  idx = gtk_combo_box_get_active (GTK_COMBO_BOX (opt_spc_opts));
  ...
  idx = gtk_combo_box_get_active (GTK_COMBO_BOX (opt_gcin_edit_display));
...
/* label 1 */
  ...
  notebooklabel = gtk_label_new(_(_L("雜項")));
  ...
  GtkWidget *button_ctrl = gtk_button_new_with_label(_(_L("ctrl 片語編輯")));
  ...
  GtkWidget *button_big5_translate_toggle = gtk_button_new_with_label(_(_L("剪貼區 正體字->簡體字")));
...
/* label 2 */
  ...
  vbox = gtk_vbox_new(FALSE, 0);
  notebooklabel = gtk_label_new(_(_L("通用")));
  gtk_notebook_append_page(GTK_NOTEBOOK(notebook), vbox, notebooklabel);
  ...
  GtkWidget *label_root_style_use = gtk_label_new(_(_L("固定 gcin 視窗位置")));
  ...
  GtkWidget *label_win_color_use = gtk_label_new(_(_L("顏色選擇")));
  ...
  GtkWidget *label_gcin_sel_key_color = gtk_label_new(_(_L("選擇鍵的顏色")));
...
/* label 3 */
  ...
  GtkWidget *label_tsin_sw = gtk_label_new(_(_L("詞音輸入[中/英]切換")));
  ...
  GtkWidget *label_tsin_buffer_size = gtk_label_new(_(_L("詞音編輯緩衝區大小")));
  ...
  GtkWidget *label_tsin_phrase_line_color = gtk_label_new(_(_L("詞音標示詞的底線顏色")));
  ...
  GtkWidget *label_tsin_cursor_color = gtk_label_new(_(_L("詞音游標的顏色")));
...
/* label 4 */
  ...
  vbox = gtk_vbox_new(FALSE, 0);
  notebooklabel = gtk_label_new(_(_L("倉頡/行列")));
  gtk_notebook_append_page(GTK_NOTEBOOK(notebook), vbox, notebooklabel);
...
/* label 5 */
  ...
  vbox = gtk_vbox_new(FALSE, 0);
  notebooklabel = gtk_label_new(_(_L("內定輸入法")));
  gtk_notebook_append_page(GTK_NOTEBOOK(notebook), vbox, notebooklabel);
