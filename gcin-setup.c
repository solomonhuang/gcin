...
static GdkColor gcin_win_gcolor_fg, gcin_win_gcolor_bg;
...
void create_appearance_conf_window()
{
  ...
  GtkWidget *label_win_color_use = gtk_label_new("使用");
  ...
  label_win_color_test = gtk_label_new("測試目前狀態");
  ...
  GtkWidget *button_fg = gtk_button_new_with_label("前景顏色");
  ...
  GtkWidget *button_bg = gtk_button_new_with_label("背景顏色");
